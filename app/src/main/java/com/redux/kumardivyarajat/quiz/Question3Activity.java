...
public class Question3Activity extends ActionBarActivity {
    public static final String TAG = Question3Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOptionA = (RadioButton) findViewById(R.id.optionA_3);
        mOptionB = (RadioButton) findViewById(R.id.optionB_3);
        mOptionC = (RadioButton) findViewById(R.id.optionC_3);
        mOptionD = (RadioButton) findViewById(R.id.optionD_3);
        mRadioGroup_1 = (RadioGroup) findViewById(R.id.answers_radiogroup_3);
        msubmit = (Button) findViewById(R.id.submit_3);
        mView = (RelativeLayout)findViewById(R.id.relative_layout3);
        mView.setBackgroundColor(colorWheel.getColor());
        msubmit.setTextColor(colorWheel.getColor());
        mTimer = (TextView)findViewById(R.id.timer3);

        do {
            Random random = new Random();
            i = random.nextInt(20);
            }while(i==Ques || i==Ques1 || i==0);
                ...
                if (e== null) {
                   ...
                   final CountDownTimer timer =  new CountDownTimer(11000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            final SharedPreferences app_preferences = PreferenceManager.getDefaultSharedPreferences(Question3Activity.this);
                            ...
                            Intent newIntent = new Intent(Question3Activity.this, Question4Activity.class);
                            newIntent.putExtra("Subject",subject);
                            newIntent.putExtra("Ques",Ques);
                            newIntent.putExtra("Ques1",Ques1);
                            newIntent.putExtra("Ques2",i);
                    ...
                    msubmit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(position+1 == Correct) {
                                Toast.makeText(Question3Activity.this, "Yay. Correct Answer.", Toast.LENGTH_SHORT).show();
                                editor.putInt("answer_value3", 1);

                            } else {
                                Toast.makeText(Question3Activity.this, "Bummer. Wrong Answer.",Toast.LENGTH_SHORT).show();
                                editor.putInt("answer_value3", 0);
                            }
                            editor.commit();
                            Intent newIntent = new Intent(Question3Activity.this, Question4Activity.class);
